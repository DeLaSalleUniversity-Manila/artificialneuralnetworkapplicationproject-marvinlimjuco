...
#ifdef FIXEDFANN
	ann = fann_create_from_file("digitde_train_fixed.net");
#else
	ann = fann_create_from_file("digitde_train_float.net");
#endif
...
#ifdef FIXEDFANN
	data = fann_read_train_from_file("digitde_test_fixed.data");
#else
	data = fann_read_train_from_file("digitde_test.data");
#endif
