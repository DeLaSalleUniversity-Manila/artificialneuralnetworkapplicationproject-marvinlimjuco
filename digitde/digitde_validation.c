...
int main()
{
	...
	fann_save(ann, "digitde_validation_float.net");

	decimal_point = fann_save_to_fixed(ann, "digitde_validation_fixed.net");
	fann_save_train_to_fixed(data, "digitde_validation_fixed.data", decimal_point);
