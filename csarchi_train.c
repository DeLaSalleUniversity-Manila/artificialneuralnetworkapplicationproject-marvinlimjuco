...
int main()
{
	...
	data = fann_read_train_from_file("csarchi_train.data");
	...
	decimal_point = fann_save_to_fixed(ann, "csarchi_train_fixed.net");
	fann_save_train_to_fixed(data, "csarchi_train_fixed.data", decimal_point);
