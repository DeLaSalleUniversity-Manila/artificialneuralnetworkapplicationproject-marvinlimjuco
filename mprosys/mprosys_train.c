...
int main()
{
	...
	fann_save(ann, "mprosys_train_float.net");

	decimal_point = fann_save_to_fixed(ann, "mprosys_train_fixed.net");
	fann_save_train_to_fixed(data, "mprosys_train_fixed.data", decimal_point);
