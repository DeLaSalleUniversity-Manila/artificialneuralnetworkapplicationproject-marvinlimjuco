...
#ifdef FIXEDFANN
	ann = fann_create_from_file("mprosys_validation_fixed.net");
#else
	ann = fann_create_from_file("mprosys_validation_float.net");
#endif
...
#ifdef FIXEDFANN
	data = fann_read_train_from_file("mprosys_validation_fixed.data");
#else
